...
### Creating an ERC-20 Token on the Kovan test network, storing it in wallet, then listing on Uniswap by providing the first liquidity pool.
...
Thanks to Gregory at Dapp University for this.
